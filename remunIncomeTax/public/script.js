...
document.querySelector(".tax-calc").addEventListener("click", () => {
  ...
  if (document.querySelector("#monthly-income").value == "") {
    ...
    let rFund = parseFloat(document.querySelector("#fund-allow").value).toFixed(
      2
    );
    ...
    let rfDur = parseFloat(document.querySelector("#rf-dur").value).toFixed(2);
    ...
    retireFund.innerHTML = numberComma(rFund * rfDur);
...
document.querySelector("#aff").addEventListener("change", (e) => {
  ...
  if (e.currentTarget.checked) {
    rfaText.innerHTML = "Retirement Fund Allowance (PF/SSF)";
    rfdText.innerHTML = "Retirement Fund Deduction (PF/CIT/SSF)";
    rfaTblText.innerHTML = "Retirement Fund (PF/SSF)";
    rfdTblText.innerHTML = "Retirement Fund (PF/CIT/SSF)";
  } else {
    rfaText.innerHTML = "Retirement Fund Allowance (PF)";
    rfdText.innerHTML = "Retirement Fund Deduction (PF/CIT)";
    rfaTblText.innerHTML = "Retirement Fund (PF)";
